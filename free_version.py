...
def gen_free_version(check_mobile=True):
  is_mobile = False
  is_ipad = False
  if check_mobile:
...
## Add free version parameters here
  scheme = "light"
  ...
  #payoff_fig.update_xaxes(showspikes=True, spikecolor="black")
  #payoff_fig.update_yaxes(showspikes=True, spikecolor="black")
  #payoff_fig.update_layout(spikedistance=1000, hoverdistance=100)
  ...
  layout = html.Div([
    html.Div([
      html.Div([
        ...
        ##], style={'flex': '1', '-webkit-flex': '1'}),
        #html.Div([
        #  html.A([html.Img(src="assets/rephi-logo-white-shadow.png", alt="Rephi logo", style={'height': '%dpx'%(sizes["heading_div"]), 'padding-right': '10px', 'float': 'right'})], href="http://rephi-dashboard.com/portal")
        #], style={'flex': '1', '-webkit-flex': '1'})
    ...
    #dbc.Col(
      html.Div([
        html.Div([
        #           html.A("Privacy policy", href="https://rephi-dashboard.com/privacypolicy", style={'font-size': '12px', 'color': '#6c757d', 'white-space': 'nowrap'}),
        #           html.A("Terms of use", href="https://rephi-dashboard.com/terms-of-use", style={'font-size': '12px', 'color': '#6c757d', 'white-space': 'nowrap'}),
                 ],style={'display': 'flex', 'display': '-webkit-flex', 'flex-direction': 'column', '-webkit-flex-direction': 'column', 'flex': '1','margin':'auto', 'padding-left': '10px'}),
        html.Div(
          html.Div([
            html.Div([
              html.A([html.Img(src="assets/rephi-text-white-shadow-logo.png", alt="Rephi logo with shadow", style={'height': sizes["image"], 'padding-left': '5px'})]),
    ...
    #html.Div([
    #  dbc.Toast(
    #    [html.P(html.A("Plans available for custom marketing dashboards for loan officers.", href="https://rephi-dashboard.com/portal", style={"color": "#6c757d"}), className="mb-0")],
    #    id="adv-toast",
    #    header="Mortgage professional?",
    #    icon="info",
    #    dismissable=True,
    #  )
    #], style={'position': 'absolute', 'bottom': '5px', 'right': '20px', 'z-index': '5000', 'opacity': '0', 'animation': 'fadeIn 1s', 'animation-delay': '5s', 'animation-fill-mode': 'forwards'})
